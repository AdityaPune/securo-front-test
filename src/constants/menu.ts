...
const menu: IMenuItem[] = [
    { label: "Dashboard", path: ["/dashboard"], headerLabel: "Dashboard", lightIcon: DashboardLight, darkIcon: DashboardDark },
    { label: "Invest", path: ["/invest", "/invest/LCI", "/invest/MWI", "/invest/BNI"], headerLabel: "Investment Strategies", lightIcon: InvestLight, darkIcon: InvestDark },
    // { label: "Wallet", path: "/", lightIcon: WalletLight, darkIcon: WalletDark },
    { label: "My Portfolio", path: ["/portfolio-performance"], headerLabel: "My Portfolio", lightIcon: AccountLight, darkIcon: AccountDark },
    { label: "Transaction History", path: ["/transaction-history"], headerLabel: "Transaction History", lightIcon: TransactionLight, darkIcon: TransactionDark },
    { label: "My Account", path: ["/my-account"], headerLabel: "My Account", lightIcon: AccountLight, darkIcon: AccountDark, disableFromSidebar: true },
    { label: "", path: ["/reset-password"], headerLabel: "", lightIcon: "", darkIcon: "", disableFromSidebar: true },
    { label: "", path: ["/verify"], headerLabel: "", lightIcon: "", darkIcon: "", disableFromSidebar: true }
]
