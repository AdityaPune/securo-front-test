...
function RecoveryLink() {
  ...
  return (
    <>
      <div
        className={
          !matches ? 'reset-password-wrapper' : 'reset-password-wrapper-small'
        }
      >
        {matches1 && (
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
            <img src={SecuroIcon}></img>
          </div>
        )}
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            ...
            >
              <Typography
                style={matches1 ? { fontSize: '24px' } : { fontSize: '32px' }}
                textAlign="center"
              >
                <b>Reset Password</b>
              </Typography>
            ...
            >
              <Typography
                style={matches1 ? { fontSize: '16px' } : { fontSize: '20px' }}
                paragraph
                textAlign="center"
              >
                Enter the email address you signed up, then we will send an
            ...
            >
              <div className="footer-container-wrapper flex-column align-items-center flex-content-center">
                ...
                <Button
                  variant="contained"
                  type="submit"
                  style={{ width: '100%', borderRadius: 8, marginTop: '24px' }}
                  size="large"
                >
                  <b>Reset password</b>
                </Button>
