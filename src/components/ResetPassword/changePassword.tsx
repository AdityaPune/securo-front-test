...
function ChangePassword() {
    ...
    const onSubmit = async (data: any) => {
        try {
            ...
            // }
            await userChangePassword(updatedPassword, currentPassword)
    ...
    return <div className={!matches ? "reset-password-wrapper" : "reset-password-wrapper-small"}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <Grid container spacing={2} flexDirection="row" justifyContent={"center"}>
                <Grid item xs={12}>
                    <Typography style={matches1 ? { fontSize: "24px", textAlign: "center", marginTop: "30px" } : { fontSize: "32px", textAlign: "center", marginTop: "30px" }}><b>Change Password</b></Typography>
                </Grid>
